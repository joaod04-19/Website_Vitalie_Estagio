...
# Descrição
Este projeto consiste no desenvolvimento de um website institucional para apresentação dos serviços da Agricultura da empresa Sementes e Costumes.
...
. Contacto (contacto.html) – página para contactar com a empresa;
